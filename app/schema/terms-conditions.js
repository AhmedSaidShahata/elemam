...
export const useTermsConditionsSchema = ({ pageTitle, pageDescription }) => {
    const { t } = useI18n()
        ...
        const breadcrumbList = {
            ...
            itemListElement: [
                ...
                },
                {
                    '@type': 'ListItem',
                    position: 2,
                    name: pageTitle.value || t('terms_and_conditions'),
                    item: `${siteUrl.value}${localePath('terms-conditions')}`,
                },
            ],
        }
